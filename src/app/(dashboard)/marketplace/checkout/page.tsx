...
export default function CheckoutPage() {
 ...
 toast.loading("Initiating secure checkout...", { id: "order-process" });

 // Step 1: Securing Funds
 setTimeout(() => {
 setProcessingStep(2);
 toast.loading("Securing funds in escrow...", { id: "order-process" });

 // Step 2: Verifying Delivery Slot
 setTimeout(() => {
 setProcessingStep(3);
 toast.success("Order confirmed!", { id: "order-process" });
 ...
 className="bg-white/50 border-glass-border h-12 rounded-xl"
 ...
 <span className="text-sm font-bold text-gray-900 ">Same City (Local Delivery)</span>
 </div>
 <div
 ...
 <span className="text-sm font-bold text-gray-900 ">Different City (Inter-state)</span>
 </div>
 </div>
 ...
 className="bg-white/50 border-glass-border min-h-[100px] rounded-xl"
 ...
 <GlassCard className="p-6 border-white/40 bg-white/80 backdrop-blur-2xl shadow-2xl">
 ...
 <span className="font-extrabold text-gray-900 ">Total Due Now</span>
 ...
 >
 <GlassCard className="p-8 border-white/20 bg-white/90 backdrop-blur-2xl text-center">
