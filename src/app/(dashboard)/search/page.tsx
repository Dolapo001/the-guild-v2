...
export default function SearchPage() {
  ...
  const [userLocation, setUserLocation] = useState({ city: "Lagos", lat: 6.4589, lng: 3.6015 }); // Mock user location
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Services</h1>
            <Button
              variant="ghost"
              size="icon"
              onClick={() => setShowFilters(!showFilters)}
              className="hidden lg:flex h-9 w-9 rounded-full bg-gray-100 hover:bg-gray-200 text-foreground/60"
            >
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div className="relative group w-full md:w-96">
            ...
            <Input
              ...
              className="pl-10 h-11 bg-white/40 border-glass-border rounded-xl focus:ring-primary/10"
            />
          </div>
            ...
            <div className="flex items-center gap-2 text-sm font-bold text-foreground/40 shrink-0">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="h-auto p-0 hover:bg-transparent text-primary flex items-center gap-1 font-bold">
