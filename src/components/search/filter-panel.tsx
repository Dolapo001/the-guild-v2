  ...
  return (
    <div className={cn("h-full flex flex-col", className)}>
      ...
      <div className="space-y-8 flex-1 overflow-y-auto pr-2">
        {/* Categories */}
        <div>
          <p className="text-[10px] font-extrabold text-foreground/40 uppercase tracking-widest mb-4">
            Categories
          </p>
            ...
            <button
              ...
              className={cn(
                ...
                filters.selectedCategory === null
                  ...
                  : "text-foreground/60 hover:bg-gray-100 hover:text-primary "
              )}
            >
              All Services
            </button>
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-2">
            {([null, 3.5, 4.0, 4.5] as (number | null)[]).map((val) => (
              <button
                key={String(val)}
        ...
        <div>
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <span
              className="text-sm font-bold text-foreground/60 group-hover:text-primary select-none"
              onClick={() => updateFilter("verifiedOnly", !filters.verifiedOnly)}
            >
              Verified Only
            </span>
      ...
      <Button
        className="w-full mt-6 bg-gray-100 hover:bg-gray-200 text-primary font-bold border-0 h-12 rounded-xl"
        onClick={() =>
          setFilters({
            verifiedOnly: false,
            radius: 15,
